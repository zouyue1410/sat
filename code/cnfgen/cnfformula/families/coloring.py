...
class KColorCmdHelper(object):
    ...
    def setup_command_line(parser):
        ...
        parser.add_argument('func',metavar='<func>',type=int,action='store',help="functional constraints on colors")
    ...
    def build_cnf(args):
        ...
        return GraphColoringFormula(G,range(1,args.k+1), functional=args.func)
